...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['proposal_id'], $_POST['action'])) {
    ...
    $action = $_POST['action'];
      ...
      if ($action === 'approve') {
        ...
        header("Location: ccssbovice_dashboard.php?approved=1");
        exit;
...
<body>
<header class="topbar">
  <div class="logo"><img src="../img/lspulogo.jpg" alt="Logo">CCS SBO VICE PRESIDENT PORTAL</div>
    ...
    <div class="admin-info">
      ...
      <div class="user-dropdown" id="userDropdown">
        ...
        <div class="dropdown-menu" id="dropdownMenu" style="display:none;">
          <?php if ($_SESSION['role'] === 'CCSSBOVice'): ?>
            <a href="ccssbovice_dashboard.php">CCS SBO Vice President Dashboard</a>
          <?php endif; ?>
...
<div id="dashboardContent" class="content">
    <h1>Welcome to the CCS SBO Vice President Dashboard</h1>
...
if ($result->num_rows > 0) {
    ...
    echo '<div class="alert alert-info text-center">No requirements found.</div>';
}
