...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2025 at 10:29 AM
...
(43, 'test', 'njbhjfvg', 12, 123, 1476, 1476),
(45, 'asdasd', 'asda', 231, 213, 49203, 49203),
(45, 'asdasd', 'asda', 231, 213, 49203, 49203),
(45, 'asdasd', 'asda', 231, 213, 49203, 49203),
(45, 'asdasd', 'asda', 231, 213, 49203, 49203),
(45, 'test', 'asdas', 131, 31, 4061, 4061),
(45, 'test', 'asdas', 131, 31, 4061, 4061),
(45, 'test', 'asdas', 131, 31, 4061, 4061),
(45, 'test', 'asdas', 131, 31, 4061, 4061),
(45, 'test', 'asdas', 131, 31, 4061, 4061),
(46, 'test', 'example', 13, 231, 3003, 3003),
(46, 'test', 'example', 13, 231, 3003, 3003),
(46, 'test', 'example', 13, 231, 3003, 3003),
(46, 'test', 'example', 13, 231, 3003, 3003),
(46, 'test', 'example', 13, 231, 3003, 3003),
...
--
-- Table structure for table `cbaa_department`
--

CREATE TABLE `cbaa_department` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `cbaa_department`
--

INSERT INTO `cbaa_department` (`id`, `username`, `password`, `role`, `email`, `fullname`, `firstlogin`, `created_at`) VALUES
(1, 'CBAA_dean', 'user12345', 'CBAADean', '', '', 'yes', '2025-06-14 04:01:01'),
(2, 'CBAA_facultyadviser', 'user12345', 'CBAAFaculty', '', '', 'yes', '2025-06-14 04:01:01'),
(3, 'CBAA_sbopresident', 'user12345', 'CBAASBOPresident', '', '', 'yes', '2025-06-14 04:01:02'),
(4, 'CBAA_sbovice', 'user12345', 'CBAASBOVice', '', '', 'yes', '2025-06-14 04:01:02'),
(5, 'CBAA_sbotreasurer', 'user12345', 'CBAASBOTreasurer', '', '', 'yes', '2025-06-14 04:01:02'),
(6, 'CBAA_sboauditor', 'user12345', 'CBAASBOAuditor', '', '', 'yes', '2025-06-14 04:01:02'),
(7, 'CBAA_sbosoo', 'user12345', 'CBAASOO', '', '', 'yes', '2025-06-14 04:01:02');
...
INSERT INTO `proposals` (`id`, `department`, `event_type`, `start_date`, `end_date`, `venue`, `time`, `status`, `budget`, `created_at`, `adviser_form`, `certification`, `financial`, `reports`, `letter_attachment`, `constitution`, `budget_approved`, `budget_amount`, `budget_status`, `status_level1`, `status_level2`, `status_level3`, `level`, `budget_file`, `submit`, `notified`, `remarks`, `disapproved_by`, `activity_plan`, `username`) VALUES
(45, 'CCS', 'MLBB TOURNA', '2025-06-15', '2025-06-16', 'Voag', '12:00 PM - 5:00 PM', 'Pending', NULL, '2025-06-14 05:04:41', 'uploads/1749877481_Frame SINTRA BOARD (3).pdf', 'uploads/1749877481_Frame SINTRA BOARD (3).pdf', 'uploads/1749877481_Frame SINTRA BOARD (3).pdf', 'uploads/1749877481_Frame SINTRA BOARD (3).pdf', 'uploads/1749877481_Frame SINTRA BOARD (3).pdf', 'uploads/1749877481_Frame SINTRA BOARD (3).pdf', '1', 4061.00, 'pending', 'Pending', 'Pending', 'Pending', 'CCS Auditor', 'budget_plan_1749877932.pdf', 'submitted', 0, NULL, NULL, 'uploads/1749877481_Frame SINTRA BOARD (3).pdf', 'CCS_sbosoo'),
(46, 'CCS', 'MLBB TOURNA 6', '2025-06-17', '2025-06-18', 'Research Hall', '12:00 PM - 5:00 PM', 'pending', NULL, '2025-06-14 05:22:15', 'uploads/1749878535_Frame SINTRA BOARD (3).pdf', 'uploads/1749878535_Frame SINTRA BOARD (3).pdf', 'uploads/1749878535_Frame SINTRA BOARD (3).pdf', 'uploads/1749878535_Frame SINTRA BOARD (3).pdf', 'uploads/1749878535_Frame SINTRA BOARD (3).pdf', 'uploads/1749878535_Frame SINTRA BOARD (3).pdf', '1', 3003.00, 'pending', 'Pending', 'Pending', 'Pending', 'CCS Treasurer', 'budget_plan_1749881642.pdf', 'submitted', 0, NULL, NULL, 'uploads/1749878535_Frame SINTRA BOARD (3).pdf', 'CCS_sbosoo'),
(47, 'CCS', 'MLBB TOURNA 3', '2025-06-19', '2025-06-21', 'Research Hall', '12:00 PM - 3:00 PM', 'pending', NULL, '2025-06-14 05:58:47', 'uploads/1749880727_Frame SINTRA BOARD (3).pdf', 'uploads/1749880727_Frame SINTRA BOARD (3).pdf', 'uploads/1749880727_Frame SINTRA BOARD (3).pdf', 'uploads/1749880727_Frame SINTRA BOARD (3).pdf', 'uploads/1749880727_Frame SINTRA BOARD (3).pdf', 'uploads/1749880727_Frame SINTRA BOARD (3).pdf', '1', 4899.00, 'pending', 'Pending', 'Pending', 'Pending', 'VP', 'budget_plan_1749881665.pdf', '', 0, NULL, NULL, 'uploads/1749880727_Frame SINTRA BOARD (3).pdf', 'CCS_sbosoo');
...
(1, 'Leorix James', 'leorix@gmail.com', 'Research Hall'),
(2, 'Dean', 'dean@gmail.com', 'Voag');
...
--
-- Indexes for table `cbaa_department`
--
ALTER TABLE `cbaa_department`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `cbaa_department`
--
ALTER TABLE `cbaa_department`
